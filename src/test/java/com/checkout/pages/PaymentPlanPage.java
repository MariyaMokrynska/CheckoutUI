...
public class PaymentPlanPage extends BasePage{
    ...
    public WebElement topPaymentFrame;

    @FindBy(xpath = "//*[@id='cdk-accordion-child-0']/div/div/div[1]//span[2]")
    public WebElement basePriceOfFirstPaymentOption;
    ...
    @FindBy(xpath = "//*[@id='cdk-accordion-child-0']/div/div/div[position()=3 or position()=4]/i")
    public WebElement excludingFeesTextUnderFirstPaymentOption;
    ...
    @FindBy(css = "mat-chip[_ngcontent-ng-c3758746842]")
    public WebElement discountBadgeElement;
}
