...
public class ClickOnNextButtonStep2 {
    ...
    public void the_user_has_completed_step_one_with_valid_information() {
        ...
        if (DriverUtils.getDriver().getCurrentUrl().endsWith("jbtp")) {
            startApplicationPage.fillParentInformation();
            BrowserUtils.waitFor(2); // Adding a small wait to ensure form updates
        }
